...
export const INDRA_RELATIONS_URL = env('INDRA_RELATIONS_URL', 'https://db.indra.bio/latest/metadata/relations/from_agents');
export const INDRA_STATEMENTS_URL = env('INDRA_STATEMENTS_URL', 'https://db.indra.bio/latest/statements/from_hash/');
